...
% We conclude with a discussion of our prospects for discovering and locating dark objects within the Milky Way from their interactions with stellar streams.
% This finding improves our prospects of discovering dark objects within the Milky Way from their interactions with stellar streams.
...
% The present-day location of an object that has impacted a stellar stream can be pinpointed with precise kinematics of the perturbed stream.
% Excitingly, GD-1 is only one of the streams that display peculiar morphology \citep[][]{pwb, bonaca2019b, bonaca2020}.
...
% Combined with dynamical inferences, dark matter can enter the domain of multi-messenger astronomy.


% The searches for dark-matter substructure in the Milky Way have been statistical so far, focusing on the total abundance \citep[e.g.,][]{carlberg2013} or the mass function of dark-matter subhalos \citep[e.g.,][]{banik2019}.

% so localized targets would truly revolutionize

% Localization would revolutionize studies of dark-matter substructure, which have been predominantly statistical and focused on measuring the mass function both in the Milky Way and on cosmological scales \citep[e.g.,][]{carlberg2013, bayer2018}.

% - test the microphysics
% - dark matter as subject of multi-messenger astronomy
% 
% - this would enable observing structures individually, at different wavelengths, gravitationally
% - stream feeders into the domain of multimessenger astronomy

% - argues for an upgrade of existing kinematic efforts (S5) to higher resolution / targeted, as a means to locate a population
% - commitment, but huge payoff

% - as shown here, precise kinematics can locate
% - a high-resolution survey might locate many

% At scrutiny, Milky Way stellar streams display peculiarities that are potential signatures of \citep[][]{pwb, bonaca2019b, bonaca2020}.
% Whenever we observed a Milky Way stellar stream in detail, we discovered peculiarities \citep[][]{pwb, bonaca2019b, bonaca2020}.
% All of the stellar streams that have been observed in detail with th Peculiarities have been observed in GD-1 and several other streams \citep[][]{pwb, bonaca2019b, bonaca2020}.
% consistent with signs of perturbation 
% - possibility we may be locate many of these
% - cite bovy, carlberg papers -- these papers show all gaps are from non-baryonic, 
% - comprehensive spectroscopic surveys of streams at a high resolution, such as the ongoing S5, but designed to provide even more precise radial velocities will be invaluable
% - commitment, but huge difference in saying statistical properties of perturbers and observing them individually
% - new opportunity for directly predicting where the perturber is now, would enable direct follow up -- opportunity to study streams in the domain of multimessenger astronomy
