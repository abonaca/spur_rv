...
% , if they are confirmed as a part of the stream.
% A tidally disrupted globular cluster that encountered a massive, compact object can result with a subset of stars extending out of the stream.
% - the family of acceptable orbits overlaps the orbits of sgr stars and dark matter
% - refer to 6d phase space / 4dim of phase space / position and velocity
% - both want to say: strongly consistent w sgr, nontrivial consistency, but also other alternatives are allowed
% - not necessary to be specific on orbital families in the abstract
% - consistent w sgr larger dm, phrase to get this across, halo gc or halo substructure

% In this scenario, small velocity offsets of the displaced stars prefer a perturber on orbital families 
% Such orbits are expected to be occupied by dark matter debris of the Sagittarius dwarf galaxy, indicating that the GD-1 perturber may be a low-mass dark-matter subhalo, or another compact object, formerly associated with Sagittarius.

% A tidally disrupting globular cluster 
% In the context of an impact scenario, this prefers orbits x.
% Such orbital families occupied by dark matter of Sgr, indicating the GD-1 perturber may be either a globular cluster, or a dark-matter subhalo, recently accreted with the Sagittarius dwarf galaxy.

% Total energy of the spur compared to the main stream, comment on progenitor vs external origin.
% point to a common, most likely globular cluster, origin.
% with little dispersion, but spread a 0.5\,dex range in $\afe$ abundance.
% Combined with a low intrinsic radial velocity dispersion, $\sigma_{V_r}\lesssim1.5\,\kms$, and consistent with a globular cluster origin.
